    ...
    <div v-else class="media mx-auto">
      <div class="container">
        ...
        <form @submit.prevent="submit">
          <!-- Pin Lama -->
          <label for="pin" class="mb-2">Masukkan PIN Lama</label>
          <br />
          ...
          <!-- Pin Baru -->
          <label for="pinCheck" class="mb-2">Masukkan PIN Baru</label>
          <br />
          <div class="input-group mb-3">
            <input
              maxlength="6"
          ...
          <!-- konfirmasi Pin -->
          <label for="pinCheck" class="mb-2">Ulangi PIN</label>
          <br />
          ...
          <!-- Submit -->
          <button v-if="btn" type="submit" class="btn btn-primary">Simpan PIN</button>
