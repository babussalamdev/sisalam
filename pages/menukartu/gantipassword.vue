  ...
  <section id="gantipin">
    <div v-if="confirmation" class="container">
      <div class="all d-flex flex-column align-items-center justify-content-center">
        ...
        <p class="w-75 text-center mb-5">Kembali ke Card untuk mengakses fitur kembali</p>
        <nuxt-link to="/card" class="btn btn-primary text-decoration-none py-2 px-5 mt-3">Kembali ke Card</nuxt-link>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="mt-5 mb-4">
          ...
          <p class="fw-light text-secondary">
            untuk mengamankan akunmu, ganti
            <br />
        ...
        <form @submit.prevent="submit">
          <!-- Pin Lama -->
          <label for="pin" class="mb-2">Masukkan Password Lama</label>
          <br />
          ...
          <!-- Pin Baru -->
          <label for="pinCheck" class="mb-2">Masukkan Password Baru</label>
          <br />
          <div class="input-group mb-3">
            <input
              id="newPin"
          ...
          <!-- konfirmasi Pin -->
          <label for="pinCheck" class="mb-2">Konfirmasi Password</label>
          <br />
          ...
          <!-- Submit -->
          <button v-if="btn" type="submit" class="btn btn-primary">Simpan Password</button>
