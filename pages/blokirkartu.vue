      ...
      <div class="container">
        ...
        <div class="card bg-gradient shadow">
          <p v-if="blok" class="p-3 bg-warning">
            Perhatian! Tindakan menonaktifkan kartu akan menyebabkan kartu tidak
            bisa digunakan untuk bertransaksi di outlet. Hanya nonaktifkan
            ketika kartu anda hilang
          </p>
          <p v-else class="p-3 bg-primary text-white">
            Kartu anda tak bisa digunakan, aktifkan untuk kembali bertransaksi
          </p>
        </div>
      </div>
    </div>
