    ...
    <div class="media mx-auto">
      <div class="container">
        ...
        <form class="mt-4" @submit.prevent="submit" id="profileUpdate">
          ...
          <!-- Pin Baru -->
          <div class="mb-3">
            <label for="emailnew" class="mb-2">Email Baru</label>
            <br />
            <div class="input-group">
              <input id="emailnew" name="email" type="email" class="form-control" placeholder="Masukkan email valid" required />
            </div>
          </div>
          <!-- Submit -->
          <button v-if="btn" type="submit" class="btn btn-primary">Update Email</button>
